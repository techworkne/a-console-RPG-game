...
void Renderer::Render(const GameField& field, const Player* player) const {
    std::cout << "\n--- Game Field ---\n";
    RenderGameStats(player);
...
void Renderer::RenderGameStats(const Player* player) const {
...
void Renderer::RenderControls() const {
    std::cout << "Controls: 'w', 'a', 's', 'd' to move. 'c' to switch combat mode. 'f' to attack. 'e' to cast spell. 'h' to help. 'q' to quit.\n";
...
void Renderer::RenderGameOver(int score) const {
    std::cout << "\n--- GAME OVER ---\n";
